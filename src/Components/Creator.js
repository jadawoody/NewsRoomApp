    ...
    <div>
      ...
      <div className="divOfCreators">
        <article className="creatorArticle">
          ...
          <p id="bio">
            Rebecca Sell is a Full-Stack Developer based in Miami, Florida. As
            of October 2020, Rebecca has been a graduate alum of Ironhack Miami!
            Rebecca plans to use her skills learned at Ironhack to launch a
            career in web development! Rebecca is intersted in projects
            including Node.js and React. To get in touch with Rebecca and to
            learn more about her professional experience, visit her LinkedIn
            page, linked below!
          </p>
          <a
        ...
        <article className="creatorArticle">
          ...
          <p id="bio">
            Jada Woody is a Full-Stack Developer based in Detroit, Michigan. As
            ...
            and to later launch a career in web development! Jada is interested
            in working more with Node.js and React. For more information on her
